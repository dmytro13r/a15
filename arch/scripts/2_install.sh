...
yay -S asusctl supergfxctl power-profiles-daemon waybar-hyprland wlogout swww xdg-desktop-portal-hyprland google-chrome firefox keepassxc timeshift slurp grim swayidle swaylock swaync waybar gucharmap otf-font-awesome ttf-arimo-nerd noto-fonts networkmanager pycharm-community-edition --noconfirm
